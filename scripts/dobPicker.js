...
jQuery.extend({
	...
	dobPicker: function(params) {
		...
		$(params.daySelector).append('<option value="' + params.dayDefault + '">' + params.dayDefault + '</option>');
		$(params.monthSelector).append('<option value="' + params.monthDefault + '">' + params.monthDefault + '</option>');
		$(params.yearSelector).append('<option value="' + params.yearDefault + '">' + params.yearDefault + '</option>');
